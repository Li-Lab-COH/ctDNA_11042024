#!/bin/bash
#SBATCH --job-name=group_reads        # Job name
#SBATCH --output=/home/janzules/ctDNA_11042024/code/slurmOutput/groupReads.out  # Standard output log
#SBATCH --error=/home/janzules/ctDNA_11042024/code/slurmOutput/groupReads.err   # Standard error log
...
grouped_bam_dir="/home/janzules/ctDNA_11042024/data/consensusPipeline/intermediate_files/grouped_bam"
histograms_dir="/home/janzules/ctDNA_11042024/data/consensusPipeline/output/histograms"
logs_dir="/home/janzules/ctDNA_11042024/data/consensusPipeline/output/logs/grouping"
