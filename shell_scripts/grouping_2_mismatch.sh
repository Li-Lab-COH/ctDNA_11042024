#!/bin/bash
#SBATCH --job-name=group_reads_2        # Job name
#SBATCH --output=/home/janzules/ctDNA_11042024/code/slurmOutput/groupReads_2.out  # Standard output log
#SBATCH --error=/home/janzules/ctDNA_11042024/code/slurmOutput/groupReads_2.err   # Standard error log
...
grouped_bam_dir="/home/janzules/ctDNA_11042024/data/consensusPipeline/intermediate_files/grouped_bam_2"
histograms_dir="/home/janzules/ctDNA_11042024/data/consensusPipeline/output/histograms_2"
logs_dir="/home/janzules/ctDNA_11042024/data/consensusPipeline/output/logs/grouping_2"
